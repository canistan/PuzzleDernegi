...
(function($){
	...
	$(document).ready(function(){
		...
		$(".map").gMap({
			...
			zoom: 11,
			markers: [{
				address: 'Tünel Cad. Medrese sok. No.12/A 34420 Karaköy',
				html: 'ÖZENSAN Sanayi Makina ve Malzemeleri A.Ş.'
			}],
			controls: {
				panControl: true,
				zoomControl: true,
		...
		$("#contact-form").validate({
			...
			messages: {
				...
				place: {
					required: "Lütfen katılmak istediğiniz yeri giriniz!"
				},
				photo: {
					required: "Lütfen fotoğrafınızı yükleyiniz!"
				},
				phone: {
					required: "Lütfen cep telefonunuzu giriniz!"
				},
				identity: {
					required: "Lütfen nufüs cüzdanınızın fotokopisini giriniz!"
				}
			},
