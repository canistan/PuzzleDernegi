        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '2rem' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '1rem', marginTop: '1.5rem' }}>
              ...
              <a href="https://www.instagram.com/puzzledernegi" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text-muted)' }} className="hover:text-[var(--primary)] transition-colors">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="https://youtube.com/@turkiyepuzzle" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text-muted)' }} className="hover:text-[#FF0000] transition-colors">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
