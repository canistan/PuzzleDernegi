...
export async function GET() {
  try {
    ...
    // Find some media images to use for gallery
    ...
    const defaultComps = [
      {
        ...
        // Add gallery images from existing media
      ...
      },
      {
        ...
        // Assign an actual image from media
        singleImage: mediaItems.length >= 5 ? mediaItems[4].id : (mediaItems.length > 0 ? mediaItems[0].id : undefined),
      }
    ];
